...
fun ParametrizedWithType.ConfigureAzureSpecificTestParameters(environment: String, config: ClientConfiguration, locationsForEnv: LocationConfiguration) {
    hiddenVariable("env.ARM_CLIENT_ID", config.clientId, "The ID of the Service Principal used for Testing")
    hiddenVariable("env.ARM_CLIENT_SECRET", config.clientSecret, "The Client Secret of the Service Principal used for Testing")
